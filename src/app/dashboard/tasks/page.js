...
function AllTasksSection({ tasks = [], onMarkComplete, currentUserEmpId, onEditTask }) {
        ...
        <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
            <div className="px-4 py-6 sm:px-0">
                <div className="bg-white shadow rounded-lg p-6 mt-6">
                    <h3 className="text-lg leading-6 font-medium text-gray-900 mb-4">All Tasks</h3>
                    {tasks.length === 0 ? (
                    ...
                    <Toast
                        type={feedback.type === "error" ? "error" : feedback.type ? feedback.type : "info"}
