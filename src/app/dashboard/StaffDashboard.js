                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center space-x-2 mb-2">
                            <h4 className="text-base font-medium text-gray-900">{task.title || "Untitled Task"}</h4>
                            {task.priority && (
                          ...
                          <div className="flex items-center text-xs text-gray-500 space-x-4">
                            ...
                            {task.manager && (
                              <span className="text-blue-600">• Assigned by: {task.manager.name} (ID: {task.manager.emp_id})</span>
                            )}
                            {task.project_id && <span>Project: {getProjectName(task.project_id)}</span>}
                          </div>
                        </div>
